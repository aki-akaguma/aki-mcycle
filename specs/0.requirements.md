...
- `AKI_MCYCLE_COLOR_SEQ_MAGENTA_ST`: Sets the start sequence for the color magenta.
...
## 5. Stateful Coloring Behavior

- **FR12:** The application SHOULD maintain color consistency for identical match strings within a specific line range (50 lines) to aid visual tracking.
