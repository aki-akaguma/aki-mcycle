...
## [Unreleased]
### Added
* `docs/reviews/2026-06-01_code_review.3.md`: code review report.

### Changed
* refactor: use `Vec::retain` for more idiomatic and efficient collection cleanup in `src/run.rs`.
* refactor: improve readability of regex capture group selection logic in `src/run.rs`.
...
* clippy: `uninlined_format_args`, `unused_imports`, `items_after_test_module`
...
* update crate: runnel
* rename file: `xtask/src/cmd.txt` to `xtask/src/aki-mcycle-cmd.txt`
